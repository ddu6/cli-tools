...
(async () => {
    ...
    clit.out(await clit.existsURL('https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4'))
    clit.out(await clit.existsURL('https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower2.mp4'))
})()